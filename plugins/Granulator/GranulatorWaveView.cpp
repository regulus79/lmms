/*
 * GranulatorWaveView.cpp - Wave renderer of the AFP
 *
...
void GranulatorWaveView::updateSampleRange()
{
...
f_cnt_t GranulatorWaveView::range() const
{
	return m_to - m_from;
}

GranulatorWaveView::GranulatorWaveView(QWidget* parent, int w, int h, Sample const* buf,
...
void GranulatorWaveView::isPlaying(f_cnt_t current_frame)
{
	m_framesPlayed = current_frame;
	update();
}

void GranulatorWaveView::enterEvent(QEvent * e)
{
	updateCursor();
}

void GranulatorWaveView::leaveEvent(QEvent * e)
{
	updateCursor();
}

void GranulatorWaveView::mousePressEvent(QMouseEvent * me)
{
	m_isDragging = true;
...
void GranulatorWaveView::mouseReleaseEvent(QMouseEvent * me)
{
	m_isDragging = false;
...
void GranulatorWaveView::mouseMoveEvent(QMouseEvent * me)
{
	if (! m_isDragging)
	{
		updateCursor(me);
...
void GranulatorWaveView::wheelEvent(QWheelEvent * we)
{
	zoom(we->angleDelta().y() > 0);
	update();
}

void GranulatorWaveView::paintEvent(QPaintEvent * pe)
{
	QPainter p(this);
...
void GranulatorWaveView::updateGraph()
{
	if (m_to == 1)
	{
...
void GranulatorWaveView::zoom(const bool out)
{
...
void GranulatorWaveView::slide(int px)
{
...
void GranulatorWaveView::slideSamplePointByPx(Point point, int px)
{
...
void GranulatorWaveView::slideSamplePointByFrames(Point point, long frameOffset, bool slideTo)
{
...
void GranulatorWaveView::slideSampleByFrames(long frameOffset)
{
	if (m_sample->sampleSize() <= 1)
	{
		return;
...
void GranulatorWaveView::reverse()
{
	slideSampleByFrames(
		m_sample->sampleSize()
			- m_sample->endFrame()
...
void GranulatorWaveView::updateCursor(QMouseEvent * me)
{
...
void GranulatorWaveView::configureKnobRelationsAndWaveViews()
{
...
void GranulatorWaveView::knob::slideTo(double v, bool check_bound)
{
...
float GranulatorWaveView::knob::getValue(const QPoint & p)
{
...
bool GranulatorWaveView::knob::checkBound(double v) const
{
