/*
 * GranulatorWaveView.h - Wave renderer of the AFP
 *
...
#ifndef LMMS_GRANULATOR_WAVE_VIEW_H
#define LMMS_GRANULATOR_WAVE_VIEW_H
...
class GranulatorView;

class GranulatorWaveView : public QWidget
{
	Q_OBJECT
protected:
...
public:
	...
	{
		const GranulatorWaveView* m_waveView;
	...
	public:
		...
		void setWaveView(const GranulatorWaveView* wv)
		{
			m_waveView = wv;
		}
...
private:
	...
	friend class GranulatorView;

public:
	GranulatorWaveView(QWidget* parent, int w, int h, Sample const* buf,
...
#endif // LMMS_GRANULATOR_WAVE_VIEW_H
